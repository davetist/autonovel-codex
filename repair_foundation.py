...
- Highest priority for this run: write a real voice profile in voice.md, clarify the story-specific operating rules, add an evidence/uncertainty matrix if useful, and standardize continuity risks.
