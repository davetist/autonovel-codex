...
% Generic ornamental motif (using dingbats)
\newcommand{\novelornament}{%
  \par\noindent\vspace{6pt}%
...
% === BOOK METADATA ===
\newcommand{\noveltitle}{Generated Novel Title}
\newcommand{\novelauthor}{Claude Hermes}
\newcommand{\novelepigraph}{Generated epigraph goes here.}
...
{\small\texttt{https://example.com/current-book}}\\[16pt]

\IfFileExists{../art/qr_book.png}{%
  \includegraphics[width=1in]{../art/qr_book.png}
}{}
...
{\small\textit{The story ends here.}}
\end{center}
