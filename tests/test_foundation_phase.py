...
class FoundationPhaseTests(unittest.TestCase):
    def test_run_foundation_writes_generator_stdout_to_layer_files_and_skips_voice_fingerprint(self):
        outputs = {
            "gen_world.py": "# Generated World\nThe river city is cut off each winter.\n",
            "gen_characters.py": "# Generated Characters\nAri Vale wants the sealed ledger opened.\n",
            ...
            "gen_canon.py": "# Generated Canon\n- The north bridge is closed each winter. (world.md)\n",
            "gen_book_profile.py": "# Book Prompt Profile: River Ledger\nUse only this foundation.\n",
    ...
    def test_foundation_generators_do_not_pin_prior_project_tokens(self):
        root = Path(__file__).resolve().parents[1]
        forbidden = [
            "PRIOR_PROJECT_PROTAGONIST",
            "PRIOR_PROJECT_CITY",
            "PRIOR_PROJECT_FACTION",
            "PRIOR_PROJECT_TITLE",
            "PRIOR_PROJECT_MAGIC_RULE",
        ]
        offenders = []
    ...
    def test_repair_output_parser_extracts_marked_file_sections(self):
        ...
        self.assertIn("bridge is locked", sections["canon.md"])
