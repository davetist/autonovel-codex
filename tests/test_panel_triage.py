...
SAMPLE_PANEL = {
    "readers": {
        "editor": {
            ...
            "missing_scene": "The novel needs one direct parent scene after the sealed transcript is sent. It should go late in chapter 24. Chapter 23 says the parent receives the private packet.",
        },
        "genre_reader": {
            ...
            "missing_scene": "The novel needs one direct parent scene after the sealed transcript rendering is sent in Chapter 23, either near the start of Chapter 24 or as a short intercut.",
        },
        "writer": {
            ...
            "missing_scene": "The novel needs one actual parent scene after the sealed transcript rendering is sent in Chapter 23.",
        },
        "first_reader": {
            ...
            "worst_scene": "The weakest scene is Chapter 16, the hearing.",
            "missing_scene": "The novel needs one private parent scene after the transcript reaches them, probably late in Chapter 23 or early in Chapter 24.",
        },
    },
    "disagreements": [
...
class PanelTriageTests(unittest.TestCase):
    ...
    def test_missing_scene_anchor_ignores_backstory_chapter_mentions(self):
        text = (
            "The novel needs one direct parent scene after the sealed transcript is sent. "
            "It should go late in chapter 24. The parent has been morally precise from chapter 5. "
            "Chapter 18 makes the protagonist's desire dangerous. Chapter 23 says the parent receives the private packet."
        )
    ...
    def test_prioritizes_panel_consensus_over_latest_full_eval_guesswork(self):
        ...
        self.assertIn("parent", targets[0]["brief_hint"])
