...
SECOND LAW: "Limitations > Powers"
  ...
  Rule: limitations should be >= capabilities in narrative prominence.
  Rule: costs should DRIVE PLOT DECISIONS.

THIRD LAW: "Expand what you have before adding something new."
  - Fewer capabilities with more applications = depth
  - Many capabilities with few applications each = grab-bag
  - No new capabilities in the final 25% that weren't foreshadowed
...
### Speculative / Rules System
  - First Law compliance: foreshadowed solutions / total rule-based solutions
  - Limitation depth: count of limitations + costs + weaknesses
  - Capability/limitation ratio: limitations >= capabilities
  - Depth score: applications shown / distinct capabilities introduced
  - No new unforeshadowed capabilities in final 25%
